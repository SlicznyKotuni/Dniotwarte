...
class QuizApp:
    ...
    def resize_wheel(self):
        ...
        wheel_size = min(width, height) - 50
        
        if wheel_size > 250:  # Minimalny rozmiar koła
            self.wheel_center_x = width // 2
            self.wheel_center_y = height // 2
            self.wheel_radius = wheel_size // 2 - 15
    ...
    def spin_wheel(self):
        ...
        def animate_spin():
            ...
            if total_angle > 0 and speed > 0.2:
                ...
                adjusted_angle = (self.angle + 180) % 360  # Dodaj przesunięcie o połowę sekcji
